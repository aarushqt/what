          ...
          <div className="sm:mt-auto pt-4 sm:pt-8">
            {session ? (
              <Link href="/dashboard" className="inline-block">
                <button className="bg-red-200 flex items-center gap-2 sm:gap-4 font-lexend text-xl sm:text-2xl mb-2 sm:mb-10 font-medium py-2 px-4 hover:cursor-pointer sm:py-3 sm:px-6 border-2 transition duration-200 shadow-[6px_6px_0px_0px_rgba(0,0,0)] sm:shadow-[10px_10px_0px_0px_rgba(0,0,0)] hover:shadow-[10px_10px_0px_0px_rgba(0,0,0)] sm:hover:shadow-[15px_15px_0px_0px_rgba(0,0,0)]">
